...
module.exports.register = function (plugin, options, next) {
	...
	plugin.ext('onRequest', function (request, next) {
		if (!routesRenamed) {
			request.server._router.specials.notFound.path = '/{notFound*}';
			if (request.server._router.specials.hasOwnProperty('cors')) {
				request.server._router.specials.cors.path = '/{cors*}';
			}
			routesRenamed = true;
		}
